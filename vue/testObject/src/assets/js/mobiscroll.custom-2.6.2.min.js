(function(a) {
	function m(f, c) {
		...
		function K(c, g, b, k, y) { ! 1 !== E("validate", [v, g, c]) && (a(".dw-ul", v).each(function(b) {
				...
				if (!e.hasClass("dw-v")) {
					for (var o = e,
					d = 0,
					l = 0; 0 <= f - d && !o.hasClass("dw-v");) d++,
					o = i.eq(f - d);
					for (; f + l < j && !e.hasClass("dw-v");) l++,
		...
		var na, H, R, v, S, O, ra, ca, P, sa, T, za, ka, Aa, V, fa, ta, X, Ba, U, ga, Y, Z, L, M, ha, ua, va, n = this,
		wa = a.mobiscroll,
		N = f,
		G = a(N),
		p = i({},
	...
	x = d(["perspectiveProperty", "WebkitPerspective", "MozPerspective", "OPerspective", "msPerspective"]),
	Q = function() {
	...
	A = function(d) {
		...
		E = i.maxDate || new Date(i.endYear, 11, 31, 23, 59, 59);
		f = f || $;
		if (J.match(/date/i)) {
			a.each(["y", "m", "d"],
			function(a, g) {
